...
// 3. Encapsulation: The bundling of data (attributes) and methods
...
// 4. Inheritance: A mechanism where a new class (subclass/child class)
// can inherit properties and behaviors from an existing class
// (superclass/parent class). This promotes code reusability and
// establishes a hierarchical relationship between classes.

// 5. Polymorphism: The ability of different classes to be treated as
//  instances of the same class through a common interface. It allows
// methods to do different things based on the object that it is
// acting upon, even though they share the same name.

// 6. Abstraction: The concept of hiding the complex implementation
